    ...
    <div class="row">
      <div class="col-xs-12 col-sm-6">
        <div class="service-featured-thumbs">
          ...
          <a href="<?php base_url();?>assets/img/service/zoom1.jpg" class="img-link">
              <img class="img-responsive" src="<?php base_url();?>assets/img/service/sv1.jpg" alt="service">
            </a>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6">
              <div class="service-thumb">
                <a href="<?php base_url();?>assets/img/service/sv2.jpg" class="img-link">
                  <img class="img-responsive" src="<?php base_url();?>assets/img/service/sv2.jpg" alt="service">
                </a>
              </div>
            </div>                      
            <div class="col-xs-12 col-sm-6">
              <div class="service-thumb">
                <a href="<?php base_url();?>assets/img/service/zoom3.jpg" class="img-link">
                  <img class="img-responsive" src="<?php base_url();?>assets/img/service/sv3.jpg" alt="service">
                </a>
              </div>
            </div>
          </div><!-- /.row -->
      ...
      <div class="col-xs-12 col-sm-6">
        <div class="service-featured-content">
          <h2>Uniquaely productivate plug imperatives.</h2>
          <p>Appropriately integrate proactive content before effective models. Quickly enable just in time scenarios after turnkey mindshare. Proactively pursue best-of-breed e-markets and stand-alone markets. Globally harness resource maximizing sources without backend communities. Proactively harness 24/7 growth strategies before accurate deliverables.</p>
          <br>
