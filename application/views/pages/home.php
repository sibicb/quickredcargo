  ...
  <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        ...
        <div class="container">
          <div class="carousel-caption">
            ...
            <h1 class="animated bounceIn">Equipment you can count on.
            <br> People you can trust.</h1>
            </div>
            <!--.carousel-caption-->
          </div>
          <!--.container-->
    ...
    <section class="why-us-setion section-padding">
      <div class="container">
        ...
        <div class="row content-row">
          <div class="col-md-12">
            <div class="css-tab css-tab2" role="tabpanel">

              <!-- Nav tabs -->
              <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#secure" aria-controls="secure" role="tab" data-toggle="tab"><i class="flaticon-logistics15"></i></a></li>
                <li role="presentation"><a href="#trackable" aria-controls="trackable" role="tab" data-toggle="tab"><i class="flaticon-logistics18"></i></a></li>
                <li role="presentation"><a href="#fast" aria-controls="fast" role="tab" data-toggle="tab"><i class="flaticon-logistics16"></i></a></li>
                <li role="presentation"><a href="#reliable" aria-controls="reliable" role="tab" data-toggle="tab"><i class="flaticon-broken43"></i></a></li>
              </ul>
                ...
                <div role="tabpanel" class="tab-pane active fade in" id="secure">
                  <div class="css-tab-content">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <img class="img-responsive" src="<?php  base_url();?>assets/img/secure.png" alt="">
                      </div><!-- /.col-md-6 -->
                    </div><!-- /.row -->
                  </div><!-- /.css-tab-content -->
                </div>
                <div role="tabpanel" class="tab-pane fade" id="trackable">
                  <div class="css-tab-content">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <img class="img-responsive" src="<?php  base_url();?>assets/img/track.png" alt="">
                      </div><!-- /.col-md-6 -->
                    </div><!-- /.row -->
                  </div><!-- /.css-tab-content -->
                </div>
                <div role="tabpanel" class="tab-pane fade" id="fast">
                  <div class="css-tab-content">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <img class="img-responsive" src="<?php  base_url();?>assets/img/fast.png" alt="">
                      </div><!-- /.col-md-6 -->
                    </div><!-- /.row -->
                  </div><!-- /.css-tab-content -->
                </div>
                <div role="tabpanel" class="tab-pane fade" id="reliable">
                  <div class="css-tab-content">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <img class="img-responsive" src="<?php  base_url();?>assets/img/reliable.png" alt="">
                      </div><!-- /.col-md-6 -->
                    </div><!-- /.row -->
                  </div><!-- /.css-tab-content -->
                </div>
              ...
              <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                  ...
                  <div class="testimonial-content">
                    ...
                    <span class="client-org"><a href="http://uiCookies" target="_blank">ThemeRox</a></span>
                    <span class="client-avatar"><img src="<?php  base_url();?>assets/img/client/client-1.jpg" alt="client avatar"></span>
