    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="page-header-wrap">
          ...
          <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li class="active">Customs Brokerage</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-3 col-sm-5 col-xs-12">
        <div class="service-sidebar sidebar-wrapper">
          ...
          <div class="widget">
            ...
            <ul class="service-list">
              ...
              <li class="active"><a href="<?php site_url();?>brokerage" class="icon-store">Customs Brokerage</a></li>
        ...
        <div class="col-md-9 col-sm-7 col-xs-12">
          <div class="single-service-content">
            ...
            <h3>As a logistic company, we are very committed to our partners to provide excellent service on a consistent basis.</h3>
            <p><i class="fa fa-caret-right" aria-hidden="true"></i> Licensed Customs Brokers</p>
